...
export default class extends Controller {
  static targets = ["requestNotice", "filterText", "person", "requestPersonId", "requestName",
                    "requestDrink", "addPersonName", "requestPersonId1", "addPersonButton",
                     "button", "submitOrder", "submitCancel", "people" ]
  ...
  selectPerson(){
    ...
    console.log("thisSelectedPersonId");
    console.log(thisSelectedPersonId);
    //if(thisSelectedPersonId && thisSelectedPersonId = )
    if(thisSelectedPersonId){             // something selected
      if(thisSelectedPersonId == thisPersonId){
      ...
      // use all the existig processing.
    }
...
//   }
  ...
  showHideRequestButtons(personNode){
    const personParentNode   = personNode.parentNode;
    const buttonSubmitOrder  = this.submitOrderTarget;
    const buttonSubmitCancel = this.submitCancelTarget; 
    console.log(buttonSubmitOrder);
